...
class Poisoner(object):
    ...
    def __init__(
        ...
        load: bool = False,
        poison_data_basepath: str = None,
        poisoned_data_path: str = None,
        **kwargs
    ):
        self.name = name
    ...
    def poison_part(self, clean_data: List, poison_data: List):
        ...
        if self.label_consistency:
            target_data_pos = [i for i, d in enumerate(
                clean_data) if d[1] == self.target_label]
        ...
        if mode == "train":
            if self.load and os.path.exists(os.path.join(self.poisoned_data_path, "train-poison.csv")):
                ...
                if self.load and os.path.exists(os.path.join(self.poison_data_basepath, "train-poison.csv")):
                    ...
                    self.save_data(poison_train_data,
                                   self.poison_data_basepath, "train-poison")
            ...
            if self.load and os.path.exists(os.path.join(self.poison_data_basepath, "dev-poison.csv")):
                ...
                self.save_data(
                    data["dev"], self.poison_data_basepath, "dev-clean")
                self.save_data(
            ...
            if self.load and os.path.exists(os.path.join(self.poison_data_basepath, "test-poison.csv")):
                ...
                self.save_data(
                    poisoned_data["test-poison"], self.poison_data_basepath, "test-poison")
            ...
            if self.load and os.path.exists(os.path.join(self.poison_data_basepath, "test-detect.csv")):
                ...
                if self.load and os.path.exists(os.path.join(self.poison_data_basepath, "test-poison.csv")):
                    ...
                    self.save_data(
                        data["test"], self.poison_data_basepath, "test-clean")
                    self.save_data(poison_test_data,
                                   self.poison_data_basepath, "test-poison")
                ...
                self.save_data(
                    poisoned_data["test-detect"], self.poison_data_basepath, "test-detect")
